...
const Features = () => {
  const abouts = [
    {
      title: "Delivery In less than 45 minutes",
      description:
        "We Deliver in less than 45 min. If time limt exceeds food on us!!",
      image: illustration1,
    },
    {
    ...
    {
      title: "Delicious and Affordable Food",
      description: "We Provide delicious food with affordable price",
      image: illustration4,
    },
  ];
  return (
